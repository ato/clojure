...
(defn dec [x]
  (clojure.lang.Numbers/minus x 1))
...
(defmacro syntax-quote [form]
  (try
   (clojure.lang.Var/pushThreadBindings {#'*sq-gensyms* {}})
   (list 'clojure.core/first (syntax-quote* form))
...
(defn read
  ...
  ([stream eof-error? eof-value recursive?]
     (if-let [clj-read (find-var 'clojure.lang.reader/read)]
       (clj-read stream eof-value)
